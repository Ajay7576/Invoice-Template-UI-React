      ...
      >
        <section>
          <div className="bg-white p-5 rounded shadow">
            <h2 className="font-bold text-3xl mb-2">Add Invoice</h2>
            ...
            <button
              onClick={() => setShowInvoice(true)} // Call the parent method on click
...
export default AddUpdateInvoice; // Default export
